      ...
      <div className='mb-6'>
        ...
        <input
          ...
          className='block w-full rounded-lg border border-gray-300
           bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-blue-500'
          placeholder='Title'
          required
      ...
      <div className='mb-6'>
        ...
        <input
          ...
          className='block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm
           text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-blue-500'
          ...
          className={`block w-56 rounded-lg border  p-2.5 text-sm
            focus:outline-none focus:ring-blue-500 ${
              errorForm?.publishDate
                ? 'border-red-300 bg-red-50 text-red-900 focus:border-red-500 focus:ring-red-500 placeholder-red-500'
